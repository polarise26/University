...
class Child extends Parent {
    ...
    // We can clealy tell that this.privateInt raises an error since we are not able
    // to access it due to its private visibility. This is contrasted by us being
    // able to access this.publicInt which is a public field of Parent class
