...
X, t = make_classification(numberSamples, n_features=numberFeatures,
n_classes=numberClasses, n_informative=2, n_redundant=0, shuffle=True,
random_state=0)

# %%
X_train, X_test, y_test, y_train = train_test_split(X, t,
