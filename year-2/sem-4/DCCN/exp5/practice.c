...
{
    int dataFrameSize;
    int dataFrame[maxSize];
    int noise[maxSize];
    int resultantFrame[maxSize];
    ...
    int intDataFrame = arr2n(dataFrame, dataFrameSize);
    int intNoise = arr2n(noise, dataFrameSize);
    ...
    int intResultantDataFrame = arr2n(resultantFrame, sizeResultantDataFrame);
